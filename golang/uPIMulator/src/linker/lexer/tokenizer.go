...
func (this *Tokenizer) InitKeywordFactory() {
	...
	this.keyword_factory.AddKeyword("rram_load_col", RRAM_LOAD_COL)
	this.keyword_factory.AddKeyword("rram_cim_mac", RRAM_CIM_MAC)
	this.keyword_factory.AddKeyword("pe_cmd_gemm", PE_CMD_GEMM)
	this.keyword_factory.AddKeyword("pe_cmd_attention_head", PE_CMD_ATTENTION_HEAD)
	this.keyword_factory.AddKeyword("pe_cmd_elementwise", PE_CMD_ELEMENTWISE)
	this.keyword_factory.AddKeyword("pe_cmd_token_prep", PE_CMD_TOKEN_PREP)
	this.keyword_factory.AddKeyword("rram_cmd_stage_act", RRAM_CMD_STAGE_ACT)
	this.keyword_factory.AddKeyword("rram_cmd_execute", RRAM_CMD_EXECUTE)
	this.keyword_factory.AddKeyword("rram_cmd_post", RRAM_CMD_POST)
	this.keyword_factory.AddKeyword("xfer_cmd_schedule", XFER_CMD_SCHEDULE)
	this.keyword_factory.AddKeyword("chiplet_cmd_sync", CHIPLET_CMD_SYNC)
